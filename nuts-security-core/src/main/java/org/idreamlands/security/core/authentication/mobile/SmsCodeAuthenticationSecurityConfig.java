 ...
 * 
 */
package org.idreamlands.security.core.authentication.mobile;
...
//	private PersistentTokenRepository persistentTokenRepository;
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		smsCodeAuthenticationFilter.setAuthenticationSuccessHandler(nutsAuthenticationSuccessHandler);
		smsCodeAuthenticationFilter.setAuthenticationFailureHandler(nutsAuthenticationFailureHandler);
