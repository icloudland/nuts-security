 ...
 * 
 */
package org.idreamlands.security.browser.authentication;
...
import org.idreamlands.security.core.properties.LoginResponseType;
import org.idreamlands.security.core.properties.SecurityProperties;
import org.idreamlands.security.core.support.SimpleResponse;
 ...
 * @author idreamlands
 */
@Component("nutsAuthenticationSuccessHandler")
public class NutsAuthenticationSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
	...
	public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
		...
		if (LoginResponseType.JSON.equals(securityProperties.getBrowser().getSignInResponseType())) {
			...
			// 如果设置了nuts.security.browser.singInSuccessUrl，总是跳到设置的地址上
